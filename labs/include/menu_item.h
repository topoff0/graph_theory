...
static const vector<menu_item> START_WORK_MENU = {
    ...
    {1, "Сгенерировать связный ациклический ориентированный граф", GREEN},
    {2, "Сгенерировать весовую матрицу", GREEN},
    {3, "Сгенерировать матрицу пропускных способностей", GREEN},
    {4, "Сгенерировать матрицу стоимости", GREEN},
    {5, "Сделать граф неориентированном деревом", YELLOW},
    {6, "Сделать граф ориентированным", YELLOW},
    {7, "Сделать граф неориентированным", YELLOW},
    ...
    {17, "Число остовных деревьев (матричная теорема Кирхгофа)", GREEN},
    {18, "Минимальный остов (Краскал)", GREEN},
    {19, "Минимальная раскраска", GREEN},
    {20, "Проверить эйлеровость и построить эйлеров цикл", GREEN},
    {21, "Фундаментальная система циклов", GREEN},
    {22, "Проверить теорему о количестве эйлеровых графов", GREEN},
    {0, "Завершить работу", RED}};
