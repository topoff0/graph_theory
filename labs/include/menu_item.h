...
static const vector<menu_item> START_WORK_MENU = {
    ...
    {2, "Сгенерировать связный ациклический ориентированный граф", BASE},
    {3, "Сгенерировать весовую матрицу", BASE},
    {4, "Сделать граф неориентированном деревом", BASE},
    {5, "Сделать граф ориентированным", BASE},
    {6, "Посчитать эксцентриситеты вершины", BASE},
    {7, "Выделить центральные вершины графа", BASE},
    {8, "Выделить диаметральные вершины графа", BASE},
