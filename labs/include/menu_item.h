...
static const vector<menu_item> START_WORK_MENU = {
    ...
    {2, "Сделать граф ациклическим", BASE},
    {3, "Сделать граф ориентированным", BASE},
    {4, "Посчитать эксцентриситеты вершины", BASE},
    {5, "Выделить центральные вершины графа", BASE},
    {6, "Выделить диаметральные вершины графа", BASE},
    {0, "Завершить работу", RED}};
;
